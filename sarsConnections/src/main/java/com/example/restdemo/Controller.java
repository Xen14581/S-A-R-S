...
public class Controller {
    ...
    public @ResponseBody String addDoctor(@RequestParam Integer id, @RequestParam String firstname,
            @RequestParam String lastname, @RequestParam String ph_no, @RequestParam String specialty) {
    ...
    public @ResponseBody String addPatient(@RequestParam Integer id, @RequestParam String firstname,
            @RequestParam String lastname, @RequestParam String dob, @RequestParam String ph_no) {
    ...
    public @ResponseBody String addAppointment(@RequestParam String datetime, @RequestParam Integer d_id,
